...
## excellent work incorporating the percentages! That really helped the visual since the grid lines are hard to see. I do think the graph here could benefit from keeping the x axis; otherwise I was confused as to what the vertical dotted line means and the bars in relation to that.
## the ordering of most unruly to least unruly is a nice touch, as is the "Is it rude to..." subtitle. Really clear narrative! -- AG
...
## this is a great start! the grouping of judgment by color is helpful --AG
```
...
## I appreciate the simplicity of the scale on the x axis here, even the simplicity of examining rude vs. not rude. In the data, were there only three categories? I am curious how you chose to group somewhat and  very rude together. However, the narrative is much clearer with your modifications after this!
```
...
## Cool concept here! I like that you are linking these ideas of essential action and rudeness. I am having some trouble interpreting the axes: for each category, for example, is the blue point the percent of individuals that say it's rude to do action given it is nonessential? Or are these individuals who believe the action is both non-essential and approximately 80% non-essential? Adding a clarifying subtitle detailing how to interpret would help here. --AG
...
## what do the colors mean here? --AG
...
## This is really cool! I like your purposeful use of error distribution here. Even with the uncertainty visualized as it is, I feel compelled to compare the means, though you state they are probably insignificant. Perhaps coloring the geom_label and geom_segment to a lighter color like gray could help?
## I really like the way this visual progressed! Starting at the boxplot and ending at this final visual changed the narrative in a really interesting way. --AG
```
